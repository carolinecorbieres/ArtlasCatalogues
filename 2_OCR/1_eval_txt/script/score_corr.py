...
fichier = '../doc/exhibCat_1943_Paris_SocieteArtistesIndependants.txt'
...
if __name__ == '__main__':
    ...
    print('Initially without problems with the tags\t\t', compte_1, '\t\t\t', "{:.2f}".format((compte_1 / total) * 100))
    print('')
    print('Initially well-formed tags\t\t\t\t', compte_2 + compte_3, '\t\t\t', "{:.2f}".format(((compte_2 + compte_3) / total) * 100))
